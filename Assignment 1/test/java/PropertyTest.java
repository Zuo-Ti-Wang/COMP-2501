...
class PropertyTest
{
    ...
    void getPriceUsd()
    {
        assertEquals(499000, property1.getPriceInUsd());
        assertEquals(1000000, property2.getPriceInUsd());
        assertEquals(840000, property3.getPriceInUsd());
    }
    ...
    {
        assertTrue(property1.isSwimmingPool());
        assertFalse(property2.isSwimmingPool());
        assertFalse(property3.isSwimmingPool());
    }
    ...
    void setPriceUsd()
    {
        property1.setPriceInUsd(777123);
        assertEquals(777123, property1.getPriceInUsd());
    }
