import ca.bcit.comp2501.ruisitang.Address;
import ca.bcit.comp2501.ruisitang.Agency;
import ca.bcit.comp2501.ruisitang.Property;
...
class AgencyTest
{
    ...
    void getPropertiesOfType()
    {
        ...
        String s2 = ") ca.bcit.comp2501.ruisitang.Property 9999: unit #9 at 99 Gretzky Way T6V7H3 in Toronto (1 bedroom): $99999.\n";
        String s3 = ") ca.bcit.comp2501.ruisitang.Property 678T: 1515 Main Street V8Y7R3 in West Vancouver (2 bedrooms plus pool): $4000000.\n";
        String s4 = ") ca.bcit.comp2501.ruisitang.Property A1212: unit #7h at 1500 Railway Avenue V9V5V4 in Richmond (4 bedrooms): $840000.\n";
