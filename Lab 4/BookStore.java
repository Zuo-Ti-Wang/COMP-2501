...
public class BookStore
{
     ...
     * @throws IllegalArgumentException if the substring parameter is blank or null.
     */
     ...
     */
    public void printNameStartEndsWith(String substring) throws IllegalNameException
    {
        if(substring == null || substring.isBlank())
        {
     ...
     * @throws IllegalNovelPropertyException if the property input is either the "author" or the "title".
     */
